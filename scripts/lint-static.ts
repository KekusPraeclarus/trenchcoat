...
const secretish = /(CURSOR_API_KEY|TELEGRAM_BOT_TOKEN|TRENCHCOAT_ROUTER_TOKEN|TRENCHCOAT_ROUTER_HMAC_KEY|DISCORD_WEBHOOK_URL|DISCORD_RESEARCH_BOT_TOKEN|FARCASTER_APP_MNEMONIC|INTAKE_SENDER_KEY|PRIVATE_KEY|SECRET_KEY|API_KEY)\s*=\s*(?:['"][^'"]+['"]|[^\s'"#]+)/
