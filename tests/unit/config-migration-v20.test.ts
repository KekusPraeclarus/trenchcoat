...
import { migrateConfigToV20, migrateConfigToV22, WALLET_SIGNALS_V20_DEFAULTS } from "../../src/migrations/config.js"
...
describe("config migration v20", () => {
  it("injects wallet_signals defaults from schema 19", () => {
    ...
    expect(ConfigSchema.parse(migrateConfigToV22(migrated)).schema).toBe(22)
  })
