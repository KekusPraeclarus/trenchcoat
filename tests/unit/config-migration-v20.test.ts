...
import { migrateConfigToV20, migrateConfigToV23, WALLET_SIGNALS_V20_DEFAULTS } from "../../src/migrations/config.js"
...
describe("config migration v20", () => {
  it("injects wallet_signals defaults from schema 19", () => {
    ...
    expect(ConfigSchema.parse(migrateConfigToV23(migrated)).schema).toBe(23)
  })
