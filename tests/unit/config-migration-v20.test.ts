...
import { migrateConfigToV20, migrateConfigToV21, WALLET_SIGNALS_V20_DEFAULTS } from "../../src/migrations/config.js"
...
describe("config migration v20", () => {
  it("injects wallet_signals defaults from schema 19", () => {
    ...
    expect(ConfigSchema.parse(migrateConfigToV21(migrated)).schema).toBe(21)
  })
